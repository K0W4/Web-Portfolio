    ...
    return (
      <div className='info-box'>
        <p className='font-medium sm:text-xl text-center'>
          I'm an undergraduate student with a passion for
          <br />
        ...
        <Link to='/about' className='neo-brutalism-white neo-btn'>
          Learn more
          <img src={arrow} alt='arrow' className='w-4 h-4 object-contain arrow' />
        </Link>
      </div>
    );
  }
    ...
    return (
      <div className='info-box'>
        <p className='font-medium text-center sm:text-xl'>
          I created a few projects along my journey as
          <br />
          I explored and learned new technologies!
        </p>
